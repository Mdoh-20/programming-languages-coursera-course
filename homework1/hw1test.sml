...
val test10 = is_older ((1,5,10),(21,3,4)) = true
val test11 = is_older ((2,2,20),(2,3,10)) = true
val test12 = is_older ((2,3,3) ,(2,3,10)) = true
					     
val test13 = is_older ((3,1,3) ,(1,4,5)) = false
val test14 = is_older ((2,10,3),(2,1,3)) = false
val test15 = is_older ((2,1,3) ,(2,1,1)) = false
...
val test41 = dates_in_month ([(2012,2,28),(2013,2,1)],2) = [(2012,2,28),
							    (2013,2,1)]
val test42 = dates_in_month ([(2012,2,28),(2013,12,1)],5) = []
val test43 = dates_in_month ([],2) = []

val test50 = dates_in_months (
...
val test51 = dates_in_months (
	[(2012,2,28),(2013,12,1),(2011,3,31),(2011,4,28)]
       ,[2,3,12,4]) = [(2012,2,28),(2011,3,31),(2013,12,1),(2011,4,28)]

val test52 = dates_in_months (
	[(2012,2,28),(2013,12,1),(2011,3,31),(2011,4,28)]
       ,[]) = []
